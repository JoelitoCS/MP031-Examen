...
<head>
    ...
    <title>Panel de Admin - HappyPets</title>
    <style>
    ...
    <div class="admin-container">
        <div class="admin-header">
            <div>
                ...
                <p class="admin-subtitle">Aquí podrás gestionar todos los aspectos de la clínica HappyPets.</p>
            </div>
            <!-- Espacio para acciones rápidas o info de usuario -->
            <div class="meta">Usuario: <strong>Administrador</strong></div>
        </div>

        <div class="actions">
            <a class="btn" href="adminAnimales.php">Gestión de Animales</a>
            <a class="btn" href="adminVisites.php">Gestión de Visitas</a>
            <a class="btn" href="adminProfesionales.php">Gestión de Profesionales(Usuarios)</a>
        ...
        <div class="card">
            ...
            <p class="meta">Desde aquí puedes añadir, editar o eliminar registros de animales, ver y gestionar visitas y controlar los profesionales (veterinarios) y sus permisos.</p>
        </div>
    </div>
</body>
</html>